...
class ApiPremiumResource {
    ...
    ($numberPlanId, $page = -1, $pageSize = -1) {
        ...
        if (is_numeric($numberPlanId))
            return ApiHelper::getApiList($this->apiHost, $uri . "$numberPlanId/keywords", $page, $pageSize);
    ...
    ($campaignId, $page = -1, $pageSize = -1) {
        ...
        if (is_numeric($campaignId))
            return ApiHelper::getApiList($this->apiHost, $uri . "$campaignId/keywords", $page, $pageSize);
        throw new Smsgh_ApiException
    ...
    public function create($object) {
        ...
        if ($object instanceof ApiCampaign) {
            ...
            return new ApiCampaign(ApiHelper::getJson
                            ($this->apiHost, 'POST', $uri, ApiHelper::toJson($object)));
    ...
    public function update($object) {
        if ($object instanceof ApiCampaign) {
            ...
            return new ApiCampaign(ApiHelper::getJson
                            ($this->apiHost, 'PUT', $uri . $object->getCampaignId(), ApiHelper::toJson($object)));
        } else if ($object instanceof ApiMoKeyWord) {
            $uri = "/" . $this->apiHost->getContextPath() . "/keywords/";
            if ($this->apiHost->getContextPath() == "") {
                $uri = '/keywords/';
            ...
            return new ApiMoKeyWord(ApiHelper::getJson
                            ($this->apiHost, 'PUT', $uri . $object->getId(), ApiHelper::toJson($object)));
        }
    ...
    public function removeKeywordFromCampaign($campaignId, $keywordId) {
        ...
        if (!is_numeric($keywordId))
            throw new Smsgh_ApiException
            ("Parameter 'keywordId' must be of type 'number'");
        ApiHelper::getData($this->apiHost, 'DELETE', $uri . "$campaignId/keywords/$keywordId");
    }
    ...
    public function getCampaignActions($campaignId, $page = -1, $pageSize = -1) {
        ...
        if (is_numeric($campaignId))
            return ApiHelper::getApiList($this->apiHost, $uri . "$campaignId/actions", $page, $pageSize);
        throw new Smsgh_ApiException
        ("Parameter 'campaignId' must be of type 'number'");
    }
    ...
    public function addDefaultReplyAction($campaignId, $message) {
        ...
        $obj->message = $message;
        return new ApiCampaign(ApiHelper::getJson
                        ($this->apiHost, 'POST', $uri . "/$campaignId/actions/default_reply", json_encode($obj)));
    }
    ...
    ($campaignId, $url, $sendResponse = 'no') {
        ...
        return new ApiCampaign(ApiHelper::getJson
                        ($this->apiHost, 'POST', $uri . "/$campaignId/actions/dynamic_url", json_encode($obj)));
    }
    ...
    public function addEmailAddressAction($campaignId, $address) {
        ...
        $obj->address = $address;
        return new ApiCampaign(ApiHelper::getJson
                        ($this->apiHost, 'POST', $uri . "/$campaignId/actions/email", json_encode($obj)));
    }
    ...
    public function addForwardToMobileAction($campaignId, $number) {
        ...
        $obj->number = $number;
        return new ApiCampaign(ApiHelper::getJson
                        ($this->apiHost, 'POST', $uri . "/$campaignId/actions/phone", json_encode($obj)));
    }
    ...
    public function addForwardToSmppAction($campaignId, $appId) {
        ...
        $obj->api_id = $appId;
        return new ApiCampaign(ApiHelper::getJson
                        ($this->apiHost, 'POST', $uri . "/$campaignId/actions/smpp", json_encode($obj)));
    }
